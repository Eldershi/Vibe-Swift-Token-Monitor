...
- 正式版本 **0.5.2（35）**，由 0.5.2-beta.1（34）收敛：活动详情及年/月明细折叠、图表实际柱形命中和可见高亮、玻璃控件交互优先、Agent 原生勾选、布局功能分组、GitHub 更新和 Icon Composer 应用图标。交付目标为 GitHub main 与 v0.5.2 Release；不安装替换本机应用。
...
- 本轮 Swift 101 项、状态回归连续10轮、后台31项、本地化292键、最终包解析器及资源/签名验证通过；公开检查通过，发布提交还须扫描全历史。ZIP 52,119,788字节，完整校验见发布记录。
