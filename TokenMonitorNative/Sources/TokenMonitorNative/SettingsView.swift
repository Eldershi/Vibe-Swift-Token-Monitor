...
struct SettingsView: View {
    ...
    var body: some View {
        TabView {
            ...
            Tab("关于与更新", systemImage: "info.circle") {
                Form {
                    Section("Token Monitor Native") {
                    ...
                    Section("Hub 兼容性") {
                        LabeledContent("连接状态", value: store.status)
        ...
        .onAppear {
            ...
            guard !args.contains("--smoke-test"), !args.contains("--preview-fixture") else { return }
